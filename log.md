...
- [Configure repositories for installing and upgrading SQL Server on Linux](https://learn.microsoft.com/en-us/sql/linux/sql-server-linux-change-repo?view=sql-server-ver17&tabs=ubuntu)
- [Quickstart: Install SQL Server and create a database on Ubuntu](https://learn.microsoft.com/en-us/sql/linux/quickstart-install-connect-ubuntu?view=sql-server-ver17&tabs=ubuntu2004%2C2505ubuntu2404%2Codbc-ubuntu-2404)

### 5-14-26

#### helpful links
- [what's the difference between iserviceprovider and iserviceproviderfactory](https://www.google.com/search?q=what%27s+the+difference+between+iserviceprovider+and+iserviceproviderfactory&oq=what%27s+the+difference+between+iserviceprovider+and+iserviceproviderfactory&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCTE5MTQ5ajBqN6gCALACAA&sourceid=chrome&ie=UTF-8)
- [.net is using linq slower than using raw sql query](https://www.google.com/search?q=.net+is+using+linq+slower+than+using+raw+sql+query&oq=.net+is+using+linq+slower+than+using+raw+sql+query&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQIRigATIHCAIQIRigATIHCAMQIRigATIHCAQQIRigATIHCAUQIRigATIHCAYQIRirAjIHCAcQIRirAjIHCAgQIRifBdIBCTIwMjA3ajBqN6gCALACAA&sourceid=chrome&ie=UTF-8)
- [.net whats the difference between database.sqlquery and database.sqlqueryraw](https://www.google.com/search?q=.net+whats+the+difference+between+database.sqlquery+and+database.sqlqueryraw&sca_esv=f9c273c5cb66282b&sxsrf=ANbL-n4qjxV805foS8QhuPcf3IxHoSv3TQ%3A1778803165292&ei=3WEGarfIEe-0wN4P_MvisAs&biw=1707&bih=898&ved=0ahUKEwj3qquW_rmUAxVvGtAFHfylGLYQ4dUDCBI&uact=5&oq=.net+whats+the+difference+between+database.sqlquery+and+database.sqlqueryraw&gs_lp=&sclient=gws-wiz-serp)
- ['The model item passed into the ViewDataDictionary is of type 'System.Collections.Generic.List`1[<>f__AnonymousType4`5[System.String,System.DateTime,System.String,System.String,WebApplication1.Models.Role]]', but this ViewDataDictionary instance requires a model item of type 'System.Collections.Generic.IEnumerable`1[WebApplication1.ViewModels.UserListViewModel]'.'](https://www.google.com/search?q=%27The+model+item+passed+into+the+ViewDataDictionary+is+of+type+%27System.Collections.Generic.List%601%5B%3C%3Ef__AnonymousType4%605%5BSystem.String%2CSystem.DateTime%2CSystem.String%2CSystem.String%2CWebApplication1.Models.Role%5D%5D%27%2C+but+this+ViewDataDictionary+instance+requires+a+model+item+of+type+%27System.Collections.Generic.IEnumerable%601%5BWebApplication1.ViewModels.UserListViewModel%5D%27.%27&oq=%27The+model+item+passed+into+the+ViewDataDictionary+is+of+type+%27System.Collections.Generic.List%601%5B%3C%3Ef__AnonymousType4%605%5BSystem.String%2CSystem.DateTime%2CSystem.String%2CSystem.String%2CWebApplication1.Models.Role%5D%5D%27%2C+but+this+ViewDataDictionary+instance+requires+a+model+item+of+type+%27System.Collections.Generic.IEnumerable%601%5BWebApplication1.ViewModels.UserListViewModel%5D%27.%27&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCDEzMTJqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8)
- [how to use websockets in .net mvc](https://www.google.com/search?q=how+to+use+websockets+in+.net+mvc&sca_esv=749643057e46af53&sxsrf=ANbL-n7UYjUljMBKPy9ubjILJJFNAyHK7w%3A1778690901964&ei=VasEaqfCOviMwbkPvqS78AE&biw=1707&bih=898&ved=0ahUKEwjnwIH727aUAxV4RjABHT7SDh4Q4dUDCBI&uact=5&oq=how+to+use+websockets+in+.net+mvc&gs_lp=Egxnd3Mtd2l6LXNlcnAiIWhvdyB0byB1c2Ugd2Vic29ja2V0cyBpbiAubmV0IG12YzIFECEYoAEyBRAhGKABMgUQIRigATIFECEYoAEyBRAhGKABMgUQIRirAkjUDFCpBlihCnABeACQAQCYAWqgAfgCqgEDMi4yuAEDyAEA-AEBmAIFoAKbA8ICBxAAGB4YsAPCAg4QABiABBiKBRiGAxiwA8ICCBAAGO8FGLADwgILEAAYgAQYogQYsAPCAggQABgWGB4YCsICBhAAGBYYHsICCxAAGIAEGIoFGIYDwgIFEAAY7wXCAggQABiABBiiBJgDAIgGAZAGB5IHAzMuMqAHnxWyBwMyLjK4B5MDwgcFMC4zLjLIBxGACAE&sclient=gws-wiz-serp)
- [.net how to send list data in websocket](https://www.google.com/search?q=.net+how+to+send+list+data+in+websocket&oq=.net+how+to+send+list+data+in+websocket&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQIRigATIHCAIQIRigATIHCAMQIRigATIHCAQQIRigATIHCAUQIRigATIHCAYQIRifBTIHCAcQIRifBTIHCAgQIRifBTIHCAkQIRifBdIBCDcxMjJqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8)
- [.net what are the different options you can configure in UseSerilogRequestLogging](https://www.google.com/search?q=.net+what+are+the+different+options+you+can+configure+in+UseSerilogRequestLogging&sca_esv=b55922efa16ed577&sxsrf=ANbL-n6KdT7bk17UGKSCFpfOUnstpWmOGw%3A1778728899060&ei=wz8Fat2sA4mFwbkP46fS4QU&biw=1707&bih=898&ved=0ahUKEwidmrjB6beUAxWJQjABHeOTNFwQ4dUDCBI&uact=5&oq=.net+what+are+the+different+options+you+can+configure+in+UseSerilogRequestLogging&gs_lp=Egxnd3Mtd2l6LXNlcnAiUS5uZXQgd2hhdCBhcmUgdGhlIGRpZmZlcmVudCBvcHRpb25zIHlvdSBjYW4gY29uZmlndXJlIGluIFVzZVNlcmlsb2dSZXF1ZXN0TG9nZ2luZ0iQF1D-BFjuFXABeAGQAQCYAWSgAeIHqgEEMTMuMbgBA8gBAPgBAZgCA6AClQHCAgoQABhHGNYEGLADwgIEECMYJ8ICBBAhGAqYAwCIBgGQBgiSBwEzoAeaHLIHATK4B44BwgcFMC4xLjLIBwqACAE&sclient=gws-wiz-serp)
- [.net why am I not able to get user information from httpcontext in middleware if I'm logged in](https://www.google.com/search?q=.net+why+am+I+not+able+to+get+user+information+from+httpcontext+in+middleware+if+I%27m+logged+in&oq=.net+why+am+I+not+able+to+get+user+information+from+httpcontext+in+middleware+if+I%27m+logged+in&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCTI1NDg5ajBqN6gCALACAA&sourceid=chrome&ie=UTF-8)
...
- [.net what does first or default do](https://www.google.com/search?q=.net+what+does+first+or+default+do&oq=.net+what+does+first+or+default+do&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQIRigATIHCAIQIRigATIHCAMQIRifBTIHCAQQIRiPAtIBCDgwMDJqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8)
- [.net how to include roles from a user when querying](https://www.google.com/search?q=.net+how+to+include+roles+from+a+user+when+querying&sca_esv=7aca6fc7736590bb&sxsrf=ANbL-n6GZbOBF8DOxVxq5QkLd0Cqf1nTqQ%3A1778529650248&ei=cjUCaunfDrGvqtsPhryKuQU&biw=1707&bih=898&ved=0ahUKEwjp4Jmgg7KUAxWxl2oFHQaeIlcQ4dUDCBE&uact=5&oq=.net+how+to+include+roles+from+a+user+when+querying&gs_lp=Egxnd3Mtd2l6LXNlcnAiMy5uZXQgaG93IHRvIGluY2x1ZGUgcm9sZXMgZnJvbSBhIHVzZXIgd2hlbiBxdWVyeWluZzIFECEYoAEyBRAhGKABMgUQIRifBTIFECEYnwUyBRAhGJ8FMgUQIRifBTIFECEYnwVIyRVQ7gVY-hNwAXgBkAEAmAFvoAGIC6oBBDQuMTC4AQPIAQD4AQGYAg-gAskLwgIKEAAYRxjWBBiwA8ICBRAhGKsCwgIHECEYChigAZgDAIgGAZAGCJIHBDQuMTGgB_tVsgcEMy4xMbgHwwvCBwYwLjEzLjLIBx-ACAE&sclient=gws-wiz-serp)
- ['ICollection<IdentityUserRole<string>>' does not contain a definition for 'Role' and no accessible extension method 'Role' accepting a first argument of type 'ICollection<IdentityUserRole<string>>' could be found (are you missing a using directive or an assembly reference?)](https://www.google.com/search?q=%27ICollection%3CIdentityUserRole%3Cstring%3E%3E%27+does+not+contain+a+definition+for+%27Role%27+and+no+accessible+extension+method+%27Role%27+accepting+a+first+argument+of+type+%27ICollection%3CIdentityUserRole%3Cstring%3E%3E%27+could+be+found+%28are+you+missing+a+using+directive+or+an+assembly+reference%3F%29&oq=%27ICollection%3CIdentityUserRole%3Cstring%3E%3E%27+does+not+contain+a+definition+for+%27Role%27+and+no+accessible+extension+method+%27Role%27+accepting+a+first+argument+of+type+%27ICollection%3CIdentityUserRole%3Cstring%3E%3E%27+could+be+found+%28are+you+missing+a+using+directive+or+an+assembly+reference%3F%29&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCjcwMDAwNGowajeoAgCwAgA&sourceid=chrome&ie=UTF-8)
- [.net how to get a collection of a model's property that will be included in another model](https://www.google.com/search?q=.net+how+to+get+a+collection+of+a+model%27s+property+that+will+be+included+in+another+model&oq=.net+how+to+get++a+collection+of+a+model%27s+property+that+will+be+included+in+another+model&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQIRiPAtIBCTM2OTQ1ajBqN6gCALACAA&sourceid=chrome&ie=UTF-8)
- [.net how to return a list of properties from a collection in razor](https://www.google.com/search?q=.net+how+to+return+a+list+of+properties+from+a+collection+in+razor&sca_esv=89f358ba4e2fcd04&biw=1707&bih=898&sxsrf=ANbL-n4KuhBF3GoWDuxMr91DRgknmlhDvw%3A1778546180122&ei=BHYCaviNB9DpptQPxPSOmA4&ved=0ahUKEwj4n6HqwLKUAxXQtIkEHUS6A-MQ4dUDCBE&uact=5&oq=.net+how+to+return+a+list+of+properties+from+a+collection+in+razor&gs_lp=&sclient=gws-wiz-serp)
- [.net mvc how to create select list item in razor](https://www.google.com/search?q=.net+mvc+how+to+create+select+list+item+in+razor&sca_esv=dbcb67f4d240fbb9&biw=1707&bih=898&sxsrf=ANbL-n4csbvZ9bn8xE_O1ICk3MEXBbxV0w%3A1778605910888&ei=Vl8DavH0NYquwbkPlYPP-Q4&ved=0ahUKEwjx942sn7SUAxUKVzABHZXBM-8Q4dUDCBE&uact=5&oq=.net+mvc+how+to+create+select+list+item+in+razor&gs_lp=&sclient=gws-wiz-serp)
- [.net is there an equivalent to the map function for a list](https://www.google.com/search?q=.net+is+there+an+equivalent+to+the+map+function+for+a+list&oq=.net+is+there+an+equivalent+to+the+map+function+for+a+list&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQIRigATIHCAIQIRigATIHCAMQIRigATIHCAQQIRigATIHCAUQIRiPAjIHCAYQIRiPAtIBCTM3OTI3ajBqN6gCALACAA&sourceid=chrome&ie=UTF-8)
- [.net mvc selectlistiems are not showing up selected](https://www.google.com/search?q=.net+mvc+selectlistiems+are+not+showing+up+selected&sca_esv=64f192ab416146fe&sxsrf=ANbL-n5-E2ZL-WXujTrGiYK1zWaXsGzSew%3A1778609603260&ei=w20DavrBD_uHwbkPtbedyQE&biw=1707&bih=898&ved=0ahUKEwi6r-KMrbSUAxX7QzABHbVbJxkQ4dUDCBE&uact=5&oq=.net+mvc+selectlistiems+are+not+showing+up+selected&gs_lp=Egxnd3Mtd2l6LXNlcnAiMy5uZXQgbXZjIHNlbGVjdGxpc3RpZW1zIGFyZSBub3Qgc2hvd2luZyB1cCBzZWxlY3RlZDIHECEYChigATIHECEYChigAUjbVFC3CFipU3ACeAGQAQCYAY8BoAHuJqoBBTE2LjMxuAEDyAEA-&sclient=gws-wiz-serp)

### 5-11-26

#### helpful links
- [Unable to create a 'DbContext' of type 'AppDBContext'. The exception 'A key cannot be configured on 'UserRole' because it is a derived type. The key must be configured on the root type 'IdentityUserRole<string>'. If you did not intend for 'IdentityUserRole<string>' to be included in the model, ensure that it is not referenced by a DbSet property on your context instance, referenced in a configuration call to 'ModelBuilder', or referenced from a navigation on a type that is included in the model.' was thrown while attempting to create an instance. For the different patterns supported at design time](https://www.google.com/search?q=Unable+to+create+a+%27DbContext%27+of+type+%27AppDBContext%27.+The+exception+%27A+key+cannot+be+configured+on+%27UserRole%27+because+it+is+a+derived+type.+The+key+must+be+configured+on+the+root+type+%27IdentityUserRole%3Cstring%3E%27.+If+you+did+not+intend+for+%27IdentityUserRole%3Cstring%3E%27+to+be+included+in+the+model%2C+ensure+that+it+is+not+referenced+by+a+DbSet+property+on+your+context+instance%2C+referenced+in+a+configuration+call+to+%27ModelBuilder%27%2C+or+referenced+from+a+navigation+on+a+type+that+is+included+in+the+model.%27+was+thrown+while+attempting+to+create+an+instance.+For+the+different+patterns+supported+at+design+time&oq=Unable+to+create+a+%27DbContext%27+of+type+%27AppDBContext%27.+The+exception+%27A+key+cannot+be+configured+on+%27UserRole%27+because+it+is+a+derived+type.+The+key+must+be+configured+on+the+root+type+%27IdentityUserRole%3Cstring%3E%27.+If+you+did+not+intend+for+%27IdentityUserRole%3Cstring%3E%27+to+be+included+in+the+model%2C+ensure+that+it+is+not+referenced+by+a+DbSet+property+on+your+context+instance%2C+referenced+in+a+configuration+call+to+%27ModelBuilder%27%2C+or+referenced+from+a+navigation+on+a+type+that+is+included+in+the+model.%27+was+thrown+while+attempting+to+create+an+instance.+For+the+different+patterns+supported+at+design+time&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCjk5MDA2MGowajmoAgCwAgA&sourceid=chrome&ie=UTF-8)
- ['ICollection<IdentityUserRole<string>>' does not contain a definition for 'Role' and no accessible extension method 'Role' accepting a first argument of type 'ICollection<IdentityUserRole<string>>' could be found (are you missing a using directive or an assembly reference?)](https://www.google.com/search?q=%27ICollection%3CIdentityUserRole%3Cstring%3E%3E%27+does+not+contain+a+definition+for+%27Role%27+and+no+accessible+extension+method+%27Role%27+accepting+a+first+argument+of+type+%27ICollection%3CIdentityUserRole%3Cstring%3E%3E%27+could+be+found+%28are+you+missing+a+using+directive+or+an+assembly+reference%3F%29&oq=%27ICollection%3CIdentityUserRole%3Cstring%3E%3E%27+does+not+contain+a+definition+for+%27Role%27+and+no+accessible+extension+method+%27Role%27+accepting+a+first+argument+of+type+%27ICollection%3CIdentityUserRole%3Cstring%3E%3E%27+could+be+found+%28are+you+missing+a+using+directive+or+an+assembly+reference%3F%29&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCjcwMDAwNGowajeoAgCwAgA&sourceid=chrome&ie=UTF-8)
- [.net mvc how highlight active link on razor page](https://www.google.com/search?q=.net+mvc+how+highlight+active+link+on+razor+page&oq=.net+mvc+how+highlight+active+link+on+razor+page&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQIRigATIHCAIQIRigATIHCAMQIRigATIHCAQQIRigATIHCAUQIRirAjIHCAYQIRirAjIHCAcQIRifBdIBCTMwNTg0ajBqNKgCArACAfEFAfihhAD3JvQ&sourceid=chrome&ie=UTF-8)
- [.net how to include an html helper class in a razor page](https://www.google.com/search?q=.net+how+to+include+an+html+helper+class+in+a+razor+page&oq=.net+how+to+include+an+html+helper+class+in+a+razor+page&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQIRigATIHCAIQIRigATIHCAMQIRigAdIBCDg0MDBqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8)
...
- [.net how to do raw a query](https://www.google.com/search?q=.net+how+to+do+raw+a+query&oq=.net+how+to+do+raw+a+query&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQABjvBTIKCAIQABiiBBiJBTIHCAMQABjvBTIKCAQQABiiBBiJBdIBCTE2NjQ5ajBqN6gCALACAA&sourceid=chrome&ie=UTF-8)
- [mssql convert utc date to est](https://www.google.com/search?q=mssql+convert+utc+date+to+est&oq=mssql+convert+utc+date+to+est&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIICAEQABgWGB4yDQgCEAAYhgMYgAQYigUyCggDEAAYgAQYogQyBwgEEAAY7wUyBwgFEAAY7wXSAQg5MzkxajBqN6gCALACAA&sourceid=chrome&ie=UTF-8)
- [chart.js Cannot use import statement outside a module](https://www.google.com/search?q=chart.js+Cannot+use+import+statement+outside+a+module&oq=chart.js+Cannot+use+import+statement+outside+a+module&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIICAEQABgWGB4yCAgCEAAYFhgeMggIAxAAGBYYHtIBCDY1NTJqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8)
- [.net how to add partials in razor](https://www.google.com/search?q=.net+how+to+add+partials+in+razor&oq=.net+how+to+add+partials+in+razor&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQIRigATIHCAIQIRigATIHCAMQIRigATIHCAQQIRigATIHCAUQIRifBTIHCAYQIRifBTIHCAcQIRifBTIHCAgQIRifBTIHCAkQIRiPAtIBCDk5MzZqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8)
...
```
    // 2. Update properties
    user.Email = newEmail;
    user.UserName = newEmail; // Often synced with Email
...
- [.net core mvc get origin url](https://www.google.com/search?q=.net+core+mvc+get+origin+url&biw=1737&bih=1148&sca_esv=4e0bfa84728bf4dd&sxsrf=ANbL-n7-Hgv3-LY7n9fphMnn0r1YEyxvNA%3A1774562645158&ei=Va3FaaetCamjptQP_YOKiQ0&ved=0ahUKEwjnq-KAyb6TAxWpkYkEHf2BItEQ4dUDCBE&uact=5&oq=.net+core+mvc+get+origin+url&gs_lp=Egxnd3Mtd2l6LXNlcnAiHC5uZXQgY29yZSBtdmMgZ2V0IG9yaWdpbiB1cmwyBRAAGO8FMggQABiJBRiiBDIIEAAYiQUYogQyBRAAGO8FMggQABiJBRiiBEjCDVCbBljyC3ABeAGQAQCYAXOgAYsDqgEDMi4yuAEDyAEA-AEBmAIFoAKdA8ICChAAGEcY1gQYsAPCAgQQIxgnwgIKECEYChigARjDBJgDAIgGAZAGCJIHAzMuMqAHvQ6yBwMyLjK4B5YDwgcFMS4zLjHIBwuACAE&sclient=gws-wiz-serp)
- [.net how to get the propert of a class parameter that was passed as a generic](https://www.google.com/search?q=.net+how+to+get+the+propert+of+a+class+parameter+that+was+passed+as+a+generic&oq=.net+how+to+get+the+propert+of+a+class+parameter+that+was+passed+as+a+generic&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCTIxMzUxajBqN6gCALACAA&sourceid=chrome&ie=UTF-8)
- [.net mailkit how to send email as html](https://www.google.com/search?q=.net+mailkit+how+to+send+email+as+html&oq=.net+mailkit+how+to+send+email+as+html&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQIRigATIHCAIQIRigATIHCAMQIRigATIHCAQQIRigATIHCAUQIRifBdIBCTExNjM4ajBqN6gCALACAA&sourceid=chrome&ie=UTF-8)
...
#### If you are going to do Dependency Injection with a created service you need to also add it in program.cs
...
var testUsers = new Faker<User>()
    .RuleFor(u => u.Bio, f => f.Lorem.Sentences(5))
...
- []()
- [InvalidOperationException: Unable to resolve service for type 'WebApplication1.Services.EmailService' while attempting to activate 'WebApplication1.Controllers.UserController'.](https://www.google.com/search?q=InvalidOperationException%3A+Unable+to+resolve+service+for+type+%27WebApplication1.Services.EmailService%27+while+attempting+to+activate+%27WebApplication1.Controllers.UserController%27.&sourceid=chrome&ie=UTF-8)
- [.net how to get email configuration from appsettings.json](https://www.google.com/search?q=.net+how+to+get+email+configuration+from+appsettings.json&oq=.net+how+to+get+email+configuration+from+appsettings.json&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQIRigATIHCAIQIRigATIHCAMQIRigATIHCAQQIRigATIHCAUQIRifBdIBCTIxNjgxajBqN6gCALACAA&sourceid=chrome&ie=UTF-8)
- [google app passwords](https://support.google.com/accounts/answer/185833?hl=en&sjid=4108040209412137281-NA)
- [.net how to use google as a mail server](https://www.google.com/search?q=.net+how+to+use+google+as+a+mail+server&oq=.net+how+to+use+google+as+a+mail+server&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQIRigATIHCAIQIRigATIHCAMQIRigATIHCAQQIRigATIHCAUQIRigATIHCAYQIRifBTIHCAcQIRifBTIHCAgQIRifBTIHCAkQIRifBdIBCDgwNDBqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8)
...
- [how to install tailwind into .net mvc](https://www.google.com/search?q=how+to+install+tailwind+into+.net+mvc&sca_esv=c1aee945acc89b8a&sxsrf=ANbL-n4vV8_pQh0F60MAnCQbXFUOuGINHw%3A1773844584196&ei=aLi6adXZC7X-p84P3sXTgAY&biw=1454&bih=1040&ved=0ahUKEwjVrc-C1qmTAxU1_8kDHd7iFGAQ4dUDCBE&uact=5&oq=how+to+install+tailwind+into+.net+mvc&gs_lp=_LACsgcFMTkuMTm4B8AewgcIMC4zNC4zLjLIB26ACAA&sclient=gws-wiz-serp)
